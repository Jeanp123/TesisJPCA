...
\usepackage{setspace}
\usepackage{float} 
\usepackage{longtable} % Para tablas largas que se dividen en varias páginas
...
\newcommand{\changefont}{%
	\fontsize{7pt}{1.5pt}\selectfont
}
\pagestyle{fancy}
\fancyhf{} %% delete default configuration of page
%%\setlength\headheight{15pt}
\fancyhead[L]{\changefont Implementación de un Chatbot Médico Pediatrico para la Prestación de Servicios en Áreas Rurales}
...
\begin{titlepage}
	...
	\begin{center}
		...
		\textbf{Implementación de un Chatbot Médico Pediatrico para la Prestación de Servicios en Áreas Rurales}
		\vspace*{8ex}\\	
...
%%Anexos
\appendix
\renewcommand{\appendixname}{Anexos}\vspace{-5mm}
\renewcommand{\appendixtocname}{Anexos}\vspace{-15mm}
\renewcommand{\appendixpagename}{Anexos}\vspace{-51mm}
\clearpage
\addappheadtotoc
\appendixpage
