...
\subsection{The Health ChatBots in Telemedicine: Intelligent Dialog System for Remote Support}
	...
	\subsubsection{Metodología empleada por los autores}	
		\begin{itemize}
				...
				\begin{figure}[h]
					\begin{center}
						\includegraphics[width=0.6\textwidth]{2/1_antecedentes/Interfaz de Usuario y Procesamiento NLP.png}
						\caption{Interfaz de Usuario y Procesamiento NLP. Fuente: CITAR AL FINAL }
					\end{center}
				\end{figure}
	...
	\begin{figure}[h]
		\begin{center}
			\includegraphics[width=0.6\textwidth]{2/1_antecedentes/Resultado1-1.png}
...
\subsection{Medbot: Conversational Artificial Intelligence Powered Chatbot for Delivering Tele-Health after COVID-19} %\citep*{pr_dehghani2018copper}}.
%\citeauthor{pr_dehghani2018copper} realizaron un artículo de investigación el cual fue publicado en la revista «Resources Policy» en el año 2018. Este fue titulado \citetitle{pr_dehghani2018copper} la cual traducida al español significa «Estimación del precio del cobre utilizando el algoritmo bat».
		\subsubsection{Planteamiento del Problema y objetivo}
...
\subsection{Intelligent Chatbot for Medical Assistance in Rural Areas} %\citep*{pr_dehghani2018copper}}
%\citeauthor{pr_dehghani2018copper} realizaron un artículo de investigación el cual fue publicado en la revista «Resources Policy» en el año 2018. Este fue titulado \citetitle{pr_dehghani2018copper} la cual traducida al español significa «Estimación del precio del cobre utilizando el algoritmo bat».
...
\subsection{HHH: An Online Medical Chatbot System based on Knowledge Graph and Hierarchical Bi-Directional Attention} %\citep*{pr_dehghani2018copper}}
%\citeauthor{pr_dehghani2018copper} realizaron un artículo de investigación el cual fue publicado en la revista «Resources Policy» en el año 2018. Este fue titulado \citetitle{pr_dehghani2018copper} la cual traducida al español significa «Estimación del precio del cobre utilizando el algoritmo bat».
	\subsubsection{Planteamiento del Problema y objetivo}
...
\subsection{HealFavor: Dataset and A Prototype System for Healthcare ChatBot} %\citep*{pr_dehghani2018copper}}
%\citeauthor{pr_dehghani2018copper} realizaron un artículo de investigación el cual fue publicado en la revista «Resources Policy» en el año 2018. Este fue titulado \citetitle{pr_dehghani2018copper} la cual traducida al español significa «Estimación del precio del cobre utilizando el algoritmo bat».
	\subsubsection{Planteamiento del Problema y objetivo}
...
\subsection{ChatDoctor: A Medical Chat Model Fine-Tuned on a Large Language Model Meta-AI (LLaMA) Using Medical Domain Knowledge} %\citep*{pr_dehghani2018copper}}
%\citeauthor{pr_dehghani2018copper} realizaron un artículo de investigación el cual fue publicado en la revista «Resources Policy» en el año 2018. Este fue titulado \citetitle{pr_dehghani2018copper} la cual traducida al español significa «Estimación del precio del cobre utilizando el algoritmo bat».
\subsubsection{Planteamiento del Problema y objetivo}
...
\subsection{Auto Response Generation in Online Medical Chat Services} %\citep*{pr_dehghani2018copper}}
%\citeauthor{pr_dehghani2018copper} realizaron un artículo de investigación el cual fue publicado en la revista «Resources Policy» en el año 2018. Este fue titulado \citetitle{pr_dehghani2018copper} la cual traducida al español significa «Estimación del precio del cobre utilizando el algoritmo bat».
	\subsubsection{Planteamiento del Problema y objetivo}
...
\subsubsection{Resultados obtenidos}
	El sistema de generación de respuestas automáticas inteligentes demostró ser altamente efectivo en la provisión de respuestas precisas y relevantes a consultas médicas en línea. Los modelos basados en BERT superaron significativamente a otros algoritmos en términos de precisión y recuerdo, con una precisión@3 de 85.41\%. La integración de técnicas de NLP y aprendizaje automático permitió generar respuestas coherentes y útiles en tiempo real, mejorando la eficiencia de las interacciones médico-paciente. Los resultados indican que el sistema puede manejar eficazmente una gran cantidad de consultas simultáneas, reduciendo la carga de trabajo de los médicos y mejorando la satisfacción de los pacientes
		...
		\begin{figure}[h]
		\begin{center}
			\includegraphics[width=0.7\textwidth]{2/1_antecedentes/Resultado-8.jpg}
			\caption{Resultado. Fuente: CITAR AL FINAL }
		\end{center}
	\end{figure}
	
	
\subsection{An Approach to Medical Diagnosis Using Smart Chatbot} %\citep*{pr_dehghani2018copper}}
%\citeauthor{pr_dehghani2018copper} realizaron un artículo de investigación el cual fue publicado en la revista «Resources Policy» en el año 2018. Este fue titulado \citetitle{pr_dehghani2018copper} la cual traducida al español significa «Estimación del precio del cobre utilizando el algoritmo bat».
...
\end{figure}
 ...
 \subsection{A Medical ChatBot} %\citep*{pr_dehghani2018copper}}
%\citeauthor{pr_dehghani2018copper} realizaron un artículo de investigación el cual fue publicado en la revista «Resources Policy» en el año 2018. Este fue titulado \citetitle{pr_dehghani2018copper} la cual traducida al español significa «Estimación del precio del cobre utilizando el algoritmo bat».
